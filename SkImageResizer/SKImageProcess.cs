...
namespace SkImageResizer
{
	public class SKImageProcess
	{
		...
		public async Task ResizeImagesAsync(string sourcePath, string destPath, double scale)
		{
			...
			Task task = Task.Run(() => ResizeImages1Async(sourcePath, destPath, scale, allFiles));
		...
		public static async Task ResizeImages1Async(string sourcePath, string destPath, double scale, List<string> allFiles)
		{
			await Task.Yield();
